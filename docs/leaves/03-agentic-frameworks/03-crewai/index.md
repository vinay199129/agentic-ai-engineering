!!! info "`03-agentic-frameworks/03-crewai`"
    ...
    💻 [View source on GitHub](https://github.com/your-handle/agentic-ai-engineering/tree/main/03-agentic-frameworks/03-crewai)
...
See [`eval-snapshot.json`](https://github.com/your-handle/agentic-ai-engineering/blob/main/03-agentic-frameworks/03-crewai/./eval-snapshot.json) for the four shared metrics on the demo set.
