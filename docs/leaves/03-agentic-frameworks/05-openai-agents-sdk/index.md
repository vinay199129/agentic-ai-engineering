!!! info "`03-agentic-frameworks/05-openai-agents-sdk`"
    ...
    💻 [View source on GitHub](https://github.com/your-handle/agentic-ai-engineering/tree/main/03-agentic-frameworks/05-openai-agents-sdk)
...
See [`eval-snapshot.json`](https://github.com/your-handle/agentic-ai-engineering/blob/main/03-agentic-frameworks/05-openai-agents-sdk/./eval-snapshot.json) for the four shared metrics on the demo set.
