...
See [`eval-snapshot.json`](./eval-snapshot.json) for `recall@{1,3,5}` of single-vector dense vs. late-interaction MaxSim plus the index size ratio (number of vectors stored).
