...
See [`eval-snapshot.json`](./eval-snapshot.json) for the latest numbers. The bench is small (30 hand-curated Q&A over 10 synthetic abstracts) — small enough to be deterministic, big enough to show the next technique helping.
