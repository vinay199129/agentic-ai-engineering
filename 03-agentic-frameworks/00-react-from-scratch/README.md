...
See [`eval-snapshot.json`](./eval-snapshot.json) for the four shared metrics on the 3-question demo set: `tool_call_accuracy`, `final_answer_grounded`, `avg_n_steps`, `avg_latency_ms`.
